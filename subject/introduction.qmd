...
If you haven't attended one of the onboarding session, **the steps to create a Github account, fork a repo, create a Github token and store it on the SSPCloud** are detailled in the [recording of the onboarding here](https://aiml4os.github.io/funathon-general-website/onboarding.html) from the minute 27. 
...
You can verify your current location by checking the terminal prompt: it should end with *funathon2024-project1*. If it does not, navigate to the correct directory using the `cd` command.
